...
class UserRegistro:
    ...
    def labels_parte1(self, frame):
        ...
        self.input_email = customtkinter.CTkEntry(master=frame, placeholder_text="example@gmail.com", width=600)
        ...
        self.input_puesto = customtkinter.CTkEntry(master=frame, placeholder_text="Puesto", width=600)
        self.input_puesto.pack(padx=40, pady=40)
        self.input_puesto.place(x=80, y=220)

        bt_registrar = customtkinter.CTkButton(master=frame, text='Registrar', command=self.registrar)
