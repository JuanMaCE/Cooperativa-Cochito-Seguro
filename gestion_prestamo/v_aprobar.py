...
global texto_imagen
from gestion_prestamo.prestamo import aprobar
...
def main():
    ...
    button_aprove = customtkinter.CTkButton(master=frame_1, text="Aprobar", fg_color=color, width=180, height=45
                                             ,command=lambda: aprobar(ib_id.get()))
    button_aprove.pack(pady=100, padx=10)
    button_aprove.place(x=10, y=150)
    return
